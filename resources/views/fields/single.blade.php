...
<h4 style="color:white;">Form Id # {{$form_id}}
  <button type="button" class="btn btn-success btnsiscussion" style="display:none;float:right;margin-top:-5px;" data-toggle="modal" data-target="#myModal">Discussion</button>
...
<br><button type="submit" class="btn btn-info" style="display:none;">Send To CBC</button>
</form>
</div>
...
<table class="table">
<tbody>
<h4 class="alert alert-success c_details" style="margin-top:15px;">Customer Details</h4>
<tr>
<td>
